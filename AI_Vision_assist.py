...
pytesseract.pytesseract.tesseract_cmd = r"C:\Users\hp\Downloads\tesseract-ocr-w64-setup-5.5.0.20241111.exe"

# Initialize Google Generative AI with API Key
GEMINI_API_KEY = "AIzaSyAqbGBuh0xeohHFlus9lo68g-vJto-7gI4"  # Replace with your valid API key
...
st.markdown(
    ...
    <footer style="text-align:center;">
        <p>Powered by <strong>Google Gemini API</strong> | ©️ Aayushi | Built with ❤️ using Streamlit</p>
    </footer>
    """,
    unsafe_allow_html=True,
)
